  ...
  return (
    <Page className="page bg-[#f4eee3] overflow-x-scroll">
      ...
      <div className="w-full h-full">
        ...
        <div className="w-fit mx-auto -mb-5 relative">
          <div className="">
            <TopUpdateBirthday />
          </div>

          <div
            className="svn-seiston -translate-y-20 w-full tracking-wider text-3xl text-[#9f7c35]">
            <p className="w-64 mx-auto text-center">Thay đổi thông tin cá nhân</p>
          </div>
        </div>
        ...
        <div className="-mt-14">
          ...
          <div className="mt-4 flex space-x-4">
            ...
            <input
              type="text"
              className="bg-[#f4eee3] h-[60px] text-lg poppins border-2 border-[#9f7c35] text-[#9f7c35] text-md rounded-lg focus:ring-3 focus:ring-zodiac-gold block w-[75%] p-3"
